...
class AffiliateAdapters
{
    ...
    public static function paginateToJson(PaginationInterface $data): array
    {
        return [
            'data' => AffiliateResource::collection($data->items())->toArray(request()), // Convert collection to array
            'meta' => [
                'total' => $data->total(),
