        ...
        <div class="card-body">
            ...
            <div class="table-responsive border-0">
                <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                    ...
                    <thead>
                        <tr>
                            <th scope="col" class="border-0 rounded-start">E-mail instrutor</th>
                    ...
                    <tbody>
                        <!-- Table row -->
                        @forelse($items as $key => $subscription)
                            <tr>
                                <!-- Table data -->
                                <td>
                                    <div class="d-flex align-items-center position-relative">
                                        ...
                                        <div class="avatar avatar-md">
                                            <img src="{{ $subscription->instructor->image ?? url('/assets/images/no-image/no-image.png') }}"
                                        ...
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                            <h6 class="mb-0"><a
                                                    href="{{ route('user.request', $subscription->id) }}"
                                                    class="stretched-link">{{ $subscription->email }}</a></h6>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-center text-sm-start">
                                    <h6 class="mb-0">{{ $subscription->transaction }}</h6>
                                </td>
