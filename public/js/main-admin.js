...
import { InjectData$Admin, QueueEvents$Admin, ViewLoader$Admin } from "./scripts/events.js";
...
function ___InitializePage () {
    ...
    window.onload = (e) => {
        ...
        if (!disableLogs) console.log('---------------=====:: Rendering Views');
        ViewLoader$Admin(DEFAULT_VIEW);
